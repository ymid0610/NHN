...
public static class InGamePrototypeSceneBuilder
{
    ...
    private const string BulletHolePath = "Assets/Sprite/BulletHole.png";
    ...
    public static void CreateScene()
    {
        ...
        ScarecrowPaperCarrier scarecrowCarrier = CreateScarecrowCarrier(boardObject.transform, windMotion, boardWarp, scarecrowSprite);
    ...
    private static ScarecrowPaperCarrier CreateScarecrowCarrier(Transform boardTransform, PaperWindMotion windMotion, PaperBoardWarp boardWarp, Sprite scarecrowSprite)
    {
